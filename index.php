...
if (! $user->rights->ludotheque->read) accessforbidden();
...
llxHeader("",$langs->trans("Ludotheque"));

print load_fiche_titre($langs->trans("Espace Ludothèque"),'','mymodule.png@ludotheque');
